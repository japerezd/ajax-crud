...
<head>
  ...
  <link rel="stylesheet" href="assets/lte/dist/css/skins/skin-blue.min.css">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active">
            <a href="#"><i class="fa fa-link"></i> <span>Link 1</span></a>
            <a href="#"><i class="fa fa-link"></i> <span>Link 2</span></a>
            <a href="#"><i class="fa fa-link"></i> <span>Link 3</span></a>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
